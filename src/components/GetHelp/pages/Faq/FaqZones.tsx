				...
				<Stack horizontalAlign="stretch" grow={1} tokens={{ childrenGap: 0 }} verticalFill>
					<Stack.Item>
						<Typography variant="h6" className={clsx(classes.text, classes.content)}>
							Ride Zones appear as shaded areas outlined in red on the map in the Lime app. These zones may restrict your speed or ability
							to end your ride. Tap on zones in the map to see what type of zone it is and the rules associated with it:
						</Typography>
						...
						<div className={clsx(classes.text, classes.content, classes.faqContentItem)}>
							<span className={classes.faqLi}>•</span>
							<span>
								Incentivized parking: park here and get rewards either in Ruler token or receive discounts on your next ride/trip{' '}
							</span>
						</div>
						<div className={clsx(classes.text, classes.content, classes.faqContentItem)}>
							<span className={classes.faqLi}>•</span>
