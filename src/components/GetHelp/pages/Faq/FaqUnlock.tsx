				...
				<Stack horizontalAlign="stretch" grow={1} tokens={{ childrenGap: 0 }} verticalFill>
					<Stack.Item>
						<Typography variant="h6" className={clsx(classes.text, classes.content)}>
							...
							scanning. In case you receive the error “under maintenance” message, it means that the respective vehicle has some fault and
							is not available for usage right now. So please select another nearest available bike/vehicle.
						</Typography>
					</Stack.Item>
				</Stack>
				<FaqFooter />
