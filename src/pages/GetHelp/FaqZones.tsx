        ...
        <Stack horizontalAlign='stretch' grow={1} tokens={{ childrenGap: 0 }} verticalFill>
          <Stack.Item>
            <Typography variant="h6" className={classes.content}>
              Ride Zones appear as shaded areas outlined in red on the map in the Lime app.
              These zones may restrict your speed or ability to end your ride.
              Tap on zones in the map to see what type of zone it is and the rules associated with it:
            </Typography>
            <div className={clsx(classes.content, classes.faqContentItem)}>
